...
function _signup() {
  _signup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            document.querySelector('.btn--signup').textContent = 'Signing Up...Please wait';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You successfully created your account');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
function updateSettings(_x, _x2) {
  return _updateSettings.apply(this, arguments);
}

function _updateSettings() {
  _updateSettings = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " sucessfully updated!"));
            }
...
function bookTour(_x) {
  return _bookTour.apply(this, arguments);
}

function _bookTour() {
  _bookTour = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe("pk_test_51LbvrLIQ9JLSLncHwj8qc0wJzHbyjAc6TRemIYM41zX0qrcERsVhLRNE9uAuOH4PbHaqnQ4NlYKftBh7VULFO7U2008BuUUsBM"); // 1) Get session from API
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resetUserPassword.js":[function(require,module,exports) {
"use strict";
...
function forgetPassword(_x) {
  return _forgetPassword.apply(this, arguments);
}

function _forgetPassword() {
  _forgetPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password reset link sent to yout email');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
function resetPassword(_x2, _x3, _x4) {
  return _resetPassword.apply(this, arguments);
}

function _resetPassword() {
  _resetPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newPassword, newPasswordConfirm, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password successfully changed');
              window.setTimeout(function () {
...
var _resetUserPassword = require("./resetUserPassword");
...
var forgetForm = document.querySelector('.form--forget-password');
var forgetBtn = document.querySelector('.btn--forget-password');
var resetForm = document.querySelector('.form--reset-password'); // DELEGATION
...
if (userSettingsForm) {
  userSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (forgetForm) {
  forgetForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return (0, _resetUserPassword.forgetPassword)(email);
...
if (resetForm) {
  resetForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var newPassword, newPasswordConfirm, token;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              newPassword = document.getElementById('password').value;
              newPasswordConfirm = document.getElementById('passwordConfirm').value;
              token = e.target.dataset.token;
              _context4.next = 6;
              return (0, _resetUserPassword.resetPassword)(newPassword, newPasswordConfirm, token);
